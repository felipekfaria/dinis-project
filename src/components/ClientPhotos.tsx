...
const ClientPhotos: React.FC = () => {
  ...
  return <div className="py-16 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-16 max-w-3xl mx-auto">
          <p className="text-lg text-foreground mb-8">Já ajudei várias famílias a vender e comprar os seus imóveis de forma segura, simples e com total transparência sempre pelo melhor preço, sem surpresas e com confiança.</p>

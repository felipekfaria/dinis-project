...
import newClient1 from '@/assets/474625330_1429740884668950_8305339077519804079_n.jpg'; // Imagem larga e destacada no mobile
...
import newClient4 from '@/assets/512655082_1157126336441421_7653544097145515534_n.jpg'; // Imagem larga
import newClient5 from '@/assets/WhatsAppimage.jpeg';

const ClientPhotos: React.FC = () => {
  const clients = [
    // 1. ADICIONAMOS A PROPRIEDADE 'isFeaturedMobile' À FOTO QUE VAI OCUPAR A LARGURA TODA
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto items-start">
          {clients.map((client) => (
            <div 
              key={client.id} 
              // 2. ALTERAÇÃO PRINCIPAL AQUI PARA O LAYOUT RESPONSIVO
              className={`

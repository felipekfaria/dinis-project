      ...
      <div className="space-y-1">
        <Label htmlFor="email" className="sr-only">Email</Label>
         <div className={inputContainerClass}>
            ...
            <Input id="email" type="email" placeholder="O seu email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className={inputClass} required />
        </div>
      </div>
